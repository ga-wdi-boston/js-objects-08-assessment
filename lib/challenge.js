...
// - a title
// - a desctiption
// Every event has functions:
// - change date
// - change time
// - change title
// - change description
// - set a reminder (rings when the event starts)
// Answer Ends Here
...
// var pet1 = new Pet('pitsy', 'cat', 'angora cat', 'meow');
// var pet2 = new Pet('hopsy', 'kengaroo', 'kengaroo breed', 'hop hop');
//console.log(new Pet('pitsy', 'cat', 'angora cat', 'meow').makeNoise());
//console.log(new Pet('hopsy', 'kengaroo', 'kengaroo breed', 'hop hop').makeNoise());
