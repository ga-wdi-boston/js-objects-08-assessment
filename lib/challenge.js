...
var Car = function (description, car) {
  this.description = "Our app manages car sales";
  this.car = function(make, model, year, abilities) {
    this.make = make;
    this.model = model;
    this.year = year;
    this.abilities = "Every can can drive, brake and park.";
  };
}
...
var Pet = function(name, species, breed, noise, makeNoise); {
  ...
  this.breed = breed;
  this.noise = function(makeNoise, species) {
    return makeNoise, species;
  }
}
