...
// Answer Starts Here
  // 'Calendar'
  // Description: App that keeps track of things via a calendar
  // Every 'calendar' needs to represent a date
  // - a month
  // - a day
  // - a year

  // Every 'calendar' should have a to-do list
  // - a task
  // - a list associated with that task (for example grocery list)

  // Every 'calendar' should have a place for goals
  // - daily goals
  // - weekly goals
  // - long term goals
