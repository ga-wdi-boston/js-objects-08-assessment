...
every 'day' can:
- get a list of tasks that are saved to do for that day

task
every 'task' has:
- length in time;
- if it has been completed field
- name
every 'task' can:
...
every 'meeting' has:
- date, time
- place it is being held at
- list of people atending
every 'meeting' can:
- start
- finish
...
pet_owner = {
  name: "John Smith",
  address: "5 Fox run, Marshfield, MA, 02..."
};
// Answer Ends Here
